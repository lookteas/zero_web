const fieldChromeMap = {
  weakness: {
    ...
    panelClassName: 'md:border-[rgba(226,232,240,0.9)] md:bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(248,250,252,0.96)_100%)]',
  },
  improvementPlan: {
    label: '改进动作',
    ...
    panelClassName: 'md:border-[rgba(216,230,225,0.96)] md:bg-[linear-gradient(180deg,rgba(255,255,255,0.99)_0%,rgba(244,250,247,0.97)_100%)]',
  },
  verificationPath: {
    label: '验证方式',
    ...
    panelClassName: 'md:border-[rgba(231,229,228,0.96)] md:bg-[linear-gradient(180deg,rgba(255,255,255,0.99)_0%,rgba(250,249,247,0.97)_100%)]',
  },
}

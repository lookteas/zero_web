...
test('history page describes the edit window as 48 hours', () => {
  assert.equal(historyPage.includes('48 小时内，可直接编辑'), true)
  assert.equal(historyPage.includes('这条记录还在 48 小时编辑窗口内'), true)
